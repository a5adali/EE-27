...
def put(hashtable, key, data, size):
    ...
    if hashtable[0][hashvalue]==None:
        ...
        if hashtable[0][hashvalue] == key:
            ...
            i = 1
            tombstone = None
            while hashtable[0][newhash]!=None and hashtable[0][hashvalue] != key:
                newhash = collision_resolver(key, size, i)
                if hashtable[0][hashvalue] == '#' and tombstone == None:
                    tombstone = newhash
            ...
            if hashtable[0][newhash] == key:
                ...
                hashtable[0][tombstone] = key
                hashtable[1][tombstone] = data
            elif hashtable[0][newhash] == None:
...
def get(hashtable, key, size):
    ...
    while hashtable[0][pos]!=None:
        if key == hashtable[0][pos] and hashtable[1][pos] != '#':
