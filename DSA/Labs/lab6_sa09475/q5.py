def sort_rectangles(rectangle_records, record_title):
    ...
    for i in range(1, len(rectangle_records)):
        current_rectangle = rectangle_records[i]
        j = i - 1
        
        while j >= 0 and current_rectangle[record_title] < rectangle_records[j][record_title]:
            rectangle_records[j + 1] = rectangle_records[j]
            j = j - 1
        
        rectangle_records[j + 1] = current_rectangle
