...
private:
    ...
    std::vector<char> num;  // Stores the digits of the number
    bool isNeg;             // Indicates if the number is negative
    bool hasAlpha;          // Indicates if the number contains non-digit characters
    /**
